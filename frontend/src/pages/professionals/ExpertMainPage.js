...
function ExpertMainPage() {
    ...
    return (
        <div className={styles.expertPage_mainContainer}>
            ...
            <div className={styles.expertPage_languageIcon} onClick={handleLanguageIconClick}>
            ...
            <h3 className={styles.expertPage_expertInterface}>{translation.expertInterface}</h3>
            ...
            {/* "Let's Go" Button */}
            <button className={styles.expertPage_ctaButton} onClick={handleCTAClick}>
